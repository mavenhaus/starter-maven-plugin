...
assert '1.2.3.4-local-SNAPSHOT' == resolvedProject.version.text()
...
assert '1.2.3.4-local-SNAPSHOT' == resolvedProject.dependencyManagement.dependencies.dependency[0].version.text()
